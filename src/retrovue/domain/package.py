...
class PackageItem(Base):
    ...
    next_item_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("package_items.id"), nullable=True)
    
    # Optional overrides
    duration_override: Mapped[int | None] = mapped_column(Integer, nullable=True)  # Override asset duration in ms
