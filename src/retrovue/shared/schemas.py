...
class PackageBase(BaseModel):
    ...
    first_asset_id: uuid.UUID | None = Field(None, description="ID of the first asset in the package")
...
class PackageItemBase(BaseModel):
    ...
    duration_override: int | None = Field(None, ge=0, description="Override duration in milliseconds")
