...
_Related: [Runtime: Channel manager](channel_manager.md) • [Runtime: Producer lifecycle](ProducerLifecycle.md) • [Components: Producers](../components/producers.md) • [Domain: Playout pipeline](../domain/PlayoutPipeline.md)_
...
- [Components: Producers](../components/producers.md) - Input producer framework
- [Domain: Playout pipeline](../domain/PlayoutPipeline.md) - Overall playout architecture
- [Components: Streaming engine](../components/streaming-engine.md) - FFmpeg and MPEG-TS technical details

_Document version: v0.1 · Last updated: 2025-01-XX_
